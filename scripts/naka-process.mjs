// 那珂市 大字境界 + 学区 → data/naka-oaza.js / naka-elementary.js / naka-junior.js
import fs from 'fs'
...
writeJs('naka-oaza.js','OAZA_GEO', turf.featureCollection(oazaFeatures))
...
processSchool('A27/A27-23_08.geojson','A27_001','A27_004','小学校区','ELEMENTARY_GEO','naka-elementary.js')
processSchool('A32/A32-23_08.geojson','A32_001','A32_004','中学校区','JUNIOR_GEO','naka-junior.js')
