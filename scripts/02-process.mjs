...
try {
  ...
  console.log('  dissolve failed, fallback union:', e.message)
  dissolved = flat
}

// 同名を1つのMultiPolygonへ統合
const groups = {}
...
writeJs('oaza.js','OAZA_GEO', turf.featureCollection(oazaFeatures))
...
processSchool('A27/A27-23_08.geojson','A27_001','A27_004','小学校区','ELEMENTARY_GEO','elementary.js')
processSchool('A32/A32-23_08.geojson','A32_001','A32_004','中学校区','JUNIOR_GEO','junior.js')
